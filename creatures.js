function creatures(type) {
    ...
    switch(type){
        ...
        case "condition":
            return ['Precisa ser decapitado','Precisa ser exorcisado','Um sacrifício deve ser feito','Uma oferenda deve ser feita','Tem que ser subornado','Tem que ser bajulado','É preciso fazer um pacto','O seu nome verdadeiro','Um item precisa ser destruído','Olhar nos olhos o enfraquece','É preciso vencer um desafio','É preciso responder enigmas','Ver uma beleza verdadeira','Sentir um coração puro','Presenciar ato de nobreza','Presenciar ato de generosidade','Ver um sorriso','Presenciar ato de castidade','Ponto fraco na cabeça','Ponto fraco no coração','Ponto fraco nos olhos','Ponto fraco na palma da mão','Ponto fraco em um ferimento antigo','Ponto fraco em uma joia incrustada','A luz da lua','O som de corvos','Passar por caminhos tortos','Passar por água corrente','Durante um solstício','Ficar embaixo d`água','Ser tratado com arrogância','Ser tratado com honra','Ser tratado com desejo','Ser tratado com insanidade','Ser tratado com curiosidade','Ser tratado com ambição'];
            break;
