$( document ).ready(function() {
  ...
  $('#btnGerarCacada').click(function(){
    ...
    var cliente = random(['Um monstro','Um cliente representando uma corporação','Um indivíduo milionário','Uma pessoa desesperada','Um contratante profissional obcecado pelo sucesso da caçada','Um grupo muito curioso acerca do alvo','Uma comunidade pobre precisando de ajuda','Um benevolente anônimo']);
