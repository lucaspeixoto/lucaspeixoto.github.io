...
function characterTraditions(classTradition,subclassTradition,skills,system){
  ...
  if((subclassTradition.indexOf("Conjuração:") >= 0) || (subclassTradition.indexOf("Conhecimento arcano:") >= 0)){
    ...
    subtradition = 'Divina';
  } else if((subclassTradition.indexOf("Magia marcial:") >= 0) || (subclassTradition.indexOf("Conhecimentos selvagens:") >= 0) || (subclassTradition.indexOf("Conhecimento primordial:") >= 0)){
    subtradition = 'Primal';
